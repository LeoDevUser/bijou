...
export default function ProductDetail() {
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-12 md:gap-8 lg:gap-12 md:items-start">
        <div className="bg-[#F0EDE8] aspect-square animate-pulse w-full md:mx-auto md:max-w-[min(100%,26rem,60vh)] lg:max-w-[min(100%,32rem,68vh)]" />
